    ...
    <section id="contact" className="border-t border-line py-28 sm:py-32">
      <div className="mx-auto max-w-shell px-6">
        <div ref={revealRef} className="reveal flex flex-col items-start gap-10 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p className="eyebrow mb-6">05 / تواصل معنا</p>
            <h2 className="font-display text-5xl font-bold leading-[1.08] tracking-tight text-ink sm:text-6xl md:text-7xl">
              {contact.heading}
              <br />
              <span className="text-red">{contact.subheading}</span>
            </h2>
            <p className="mt-7 max-w-md text-lg leading-9 text-muted">{contact.supportingText}</p>
