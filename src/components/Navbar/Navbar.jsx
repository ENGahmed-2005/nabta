...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-0.5 rounded-full border border-line/90 bg-surface/[0.88] px-2.5 py-2 shadow-[0_12px_34px_-12px_rgba(17,24,39,0.22),0_2px_8px_-2px_rgba(17,24,39,0.08)] backdrop-blur-[14px] sm:gap-0.5">
        <a
          href="#home"
